...
<!-- Animated Header -->
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0d1117,50:1a1b27,100:6c63ff&height=220&section=header&text=Kshitiz%20Bansal&fontSize=50&fontColor=ffffff&animation=fadeIn&fontAlignY=35&desc=AI%20Engineer%20%7C%20Full-Stack%20Developer%20%7C%20Deep%20Learning%20Researcher&descSize=16&descAlignY=55&descColor=8b949e" width="100%" />

<!-- Typing Animation -->
<a href="https://git.io/typing-svg"><img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=600&size=22&duration=3000&pause=1000&color=6C63FF&center=true&vCenter=true&multiline=true&repeat=true&width=700&height=100&lines=%F0%9F%A7%A0+Building+intelligent+systems+that+think;%F0%9F%94%AC+From+neural+networks+to+production+APIs;%E2%9A%A1+Turning+complex+problems+into+elegant+code" alt="Typing SVG" /></a>
...
class KshitizBansal:
    ...
    def current_focus(self):
        return [
            "🔬 Researching precision optimization in neural networks",
            "⚖️ Building AI-powered legal tech solutions",
            "🎓 Developing intelligent education platforms",
            "🏗️ Designing production-grade ML pipelines"
        ]
    
    def fun_fact(self):
        return "I debug neural networks for fun and read research papers for breakfast ☕"
```
...
- 🔭 Currently working on **AI-powered applications** that bridge research & production
- 🧠 Deep into **Mixed Precision Training**, **NLP**, and **ETL pipelines**
- 💡 Passionate about making **complex AI accessible** to everyone
- 🌱 Always learning — currently exploring **LLMs** and **Agentic AI**
- 📍 Based in **Chennai, India**
- ⚡ Fun fact: *I believe the best code is the one that makes you say "wow, that's elegant"*
...
|---------|-------------|------------|------------|
| ⚖️ **[Legal Doc Simplifier](https://github.com/Kshitizbansal02/legal-document-simplifier-nlp)** | AI-powered system that transforms complex legal jargon into plain language | `TypeScript` `NLP` `AI` | Real-world NLP application solving accessibility |
| 🔬 **[PrecisionBench CNN](https://github.com/Kshitizbansal02/-precisionbench-cnn)** | Comparative study of FP32 vs Mixed Precision training on CIFAR-10 | `Python` `PyTorch` `FastAPI` | Interactive dashboard + performance benchmarks |
| 🎓 **[EduPulse AI](https://github.com/Kshitizbansal02/EduPulse-AI)** | Intelligent education platform powered by AI | `HTML` `JavaScript` `AI` | Personalized learning experience engine |
| 🔄 **[ETL-ML Integration](https://github.com/Kshitizbansal02/ETL-Machine-Learning-Integration)** | Production-grade pipelines for ML-ready datasets | `Python` `ETL` `ML` | End-to-end data engineering for ML |
...
<a href="https://github.com/Kshitizbansal02">
  <img src="https://img.shields.io/badge/-Kshitizbansal02-181717?style=flat-square&logo=GitHub&logoColor=white" height="30"/>
</a>
